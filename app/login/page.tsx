      ...
      <main className="relative z-10 flex-1 flex items-center justify-center px-4 py-16">
        <div className="w-full max-w-sm">
          ...
          <div ref={cardRef} className="rounded-2xl border border-white/10 bg-gray-900/50 backdrop-blur-sm p-7" style={{ opacity: 0 }}>
            ...
            {/* Social */}
            <div className="fi grid grid-cols-2 gap-3" style={{ opacity: 0 }}>
...
function SocialButton({ icon, label }: { icon: React.ReactNode; label: string }) {
  return (
    <button className="flex items-center justify-center gap-2 rounded-xl border border-white/10 bg-gray-950/60 py-2.5 text-sm text-gray-300 hover:border-white/20 hover:text-white transition-colors">
      {icon}
      {label}
    </button>
  );
